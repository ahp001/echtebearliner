  ...
  return (
    ...
    >
      ...
      <View style={styles.card}>
        <SectionTitle title="ECHTE BÄRLINER® GmbH" />
        ...
        <Text style={styles.textBlock}>Markeninhaber: Ugur Maras</Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.paragraph}>
          Alle Texte, Bilder, Graphiken, Ton-, Video- und Animationsdateien sowie
        ...
        <Text style={styles.paragraph}>
          Einige ECHTE BÄRLINER GmbH®-Internet-Seiten enthalten auch Bilder, die
          dem Urheberrecht derjenigen unterliegen, die diese zur Verfügung
          gestellt haben.
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.paragraph}>
          Die Informationen stellt ECHTE BÄRLINER GmbH® ohne jegliche Zusicherung
        ...
        <Text style={styles.paragraph}>
          ...
          betreffend die Handlungsfähigkeit, die Eignung für bestimmte Zwecke oder
          den Nichtverstoß gegen Gesetze und Patente.
        </Text>
        <Text style={styles.paragraph}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.paragraph}>
          ECHTE BÄRLINER GmbH® möchte Ihnen ein innovatives und informatives
        ...
        <Text style={styles.paragraph}>
          ...
          BÄRLINER GmbH® ihr geistiges Eigentum, einschließlich Patente,
          ...
          ECHTE BÄRLINER GmbH® gewähren können.
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.paragraph}>
          ...
          Inhalt und Aktualisierung nicht dem Einflussbereich der ECHTE BÄRLINER
          GmbH® unterliegen.
        </Text>
        <Text style={styles.paragraph}>Für alle diese Links gilt:</Text>
        <Text style={styles.paragraph}>
          ECHTE BÄRLINER GmbH® hat keinen Einfluss auf Gestaltung und Inhalte
          fremder Internetseiten. Sie distanziert sich daher von allen fremden
          Inhalten, auch wenn von Seiten der ECHTE BÄRLINER GmbH® auf diese
          externe Seiten ein Link gesetzt wurden.
        </Text>
        <Text style={styles.paragraph}>

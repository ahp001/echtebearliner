...
const CONTENT: Record<Lang, ImpressumContent> = {
  de: {
    back: "Zurück",
    pageTitle: "Impressum",
    brandTitle: "ECHTE BÄRLINER® GmbH",
    brandSub: "EINE MARKE DER MARAS GROUP®",
    address: ["Zollernstraße 11", "86154 Augsburg"],
    company: [
      "Geschäftsführer: Ugur Maras",
      "Steuer-Nr. 103/125/20058",
      "USt-IdNr.: DE451509739",
    ],
    court: ["Amtsgericht Augsburg", "Sitz: Augsburg"],
    owner: ["Markeninhaber: Ugur Maras"],
    ...
    copyrightText: [
      "Copyright 2024 ECHTE BÄRLINER GmbH®. Alle Rechte vorbehalten.",
      ...
      "Einige ECHTE BÄRLINER GmbH®-Internet-Seiten enthalten auch Bilder, die dem Urheberrecht derjenigen unterliegen, die diese zur Verfügung gestellt haben.",
    ],
    warrantyText: [
      "Die Informationen stellt ECHTE BÄRLINER GmbH® ohne jegliche Zusicherung oder Gewährleistung jedweder Art, sei sie ausdrücklich oder stillschweigend, zur Verfügung.",
      "Ausgeschlossen sind auch alle stillschweigenden Gewährleistungen betreffend die Handlungsfähigkeit, die Eignung für bestimmte Zwecke oder den Nichtverstoß gegen Gesetze und Patente.",
    ...
    licenseText: [
      "ECHTE BÄRLINER GmbH® möchte Ihnen ein innovatives und informatives Internet-Programm anbieten. Wir hoffen deshalb, dass Sie sich über unsere kreative Gestaltung genauso freuen wie wir.",
      "Wir bitten Sie aber dennoch um Verständnis dafür, dass die ECHTE BÄRLINER GmbH® ihr geistiges Eigentum, einschließlich Patente, Handelsmarken und Urheberrechte, schützen muss und diese Internet-Seiten keinerlei Lizenzrechte an dem geistigen Eigentum der ECHTE BÄRLINER GmbH® gewähren können.",
    ],
    linksText: [
      ...
      "Wir haben auf unseren Seiten Links zu Seiten im Internet gelegt, deren Inhalt und Aktualisierung nicht dem Einflussbereich der ECHTE BÄRLINER GmbH® unterliegen.",
      "Für alle diese Links gilt:",
      "ECHTE BÄRLINER GmbH® hat keinen Einfluss auf Gestaltung und Inhalte fremder Internetseiten. Sie distanziert sich daher von allen fremden Inhalten, auch wenn von Seiten der ECHTE BÄRLINER GmbH® auf diese externe Seiten ein Link gesetzt wurden.",
  ...
  en: {
    ...
    address: ["Zollernstraße 11", "86154 Augsburg"],
    company: [
      "Managing Director: Ugur Maras",
      "Tax No. 103/125/20058",
      "VAT ID No.: DE451509739",
    ],
    court: ["District Court Augsburg", "Registered office: Augsburg"],
    owner: ["Trademark owner: Ugur Maras"],
    web: ["info@echtebaerliner.de", "www.echtebaerliner.de"],
    sections: {
    ...
    copyrightText: [
      "Copyright 2024 ECHTE BÄRLINER GmbH®. All rights reserved.",
      ...
      "Some ECHTE BÄRLINER GmbH® web pages also contain images that are subject to the copyright of those who provided them.",
    ],
    warrantyText: [
      "ECHTE BÄRLINER GmbH® provides the information without any representation or warranty of any kind, whether express or implied.",
    ...
    licenseText: [
      "ECHTE BÄRLINER GmbH® would like to offer you an innovative and informative internet program. We therefore hope that you enjoy our creative design as much as we do.",
      "However, we ask for your understanding that ECHTE BÄRLINER GmbH® must protect its intellectual property, including patents, trademarks and copyrights, and that these web pages cannot grant any license rights to the intellectual property of ECHTE BÄRLINER GmbH®.",
    ],
    linksText: [
      ...
      "We have placed links on our pages to websites on the internet whose content and updates are not within the sphere of influence of ECHTE BÄRLINER GmbH®.",
      "The following applies to all these links:",
      "ECHTE BÄRLINER GmbH® has no influence on the design and content of external websites. It therefore distances itself from all external content, even if a link to these external pages has been set from ECHTE BÄRLINER GmbH® pages.",
  ...
  hr: {
    ...
    company: [
      "Direktor: Ugur Maras",
      "Porezni broj: 103/125/20058",
      "PDV ID broj: DE451509739",
    ],
    court: ["Općinski sud Augsburg", "Sjedište: Augsburg"],
    owner: ["Vlasnik robne marke: Ugur Maras"],
    web: ["info@echtebaerliner.de", "www.echtebaerliner.de"],
    sections: {
    ...
    copyrightText: [
      "Copyright 2024 ECHTE BÄRLINER GmbH®. Sva prava pridržana.",
      ...
      "Neke ECHTE BÄRLINER GmbH® internetske stranice također sadrže slike koje podliježu autorskim pravima osoba koje su ih stavile na raspolaganje.",
    ],
    warrantyText: [
      "ECHTE BÄRLINER GmbH® pruža informacije bez ikakvih izjava ili jamstava bilo koje vrste, bilo izričitih ili prešutnih.",
    ...
    licenseText: [
      "ECHTE BÄRLINER GmbH® želi vam ponuditi inovativan i informativan internetski program. Zato se nadamo da ćete uživati u našem kreativnom dizajnu jednako kao i mi.",
      "Ipak, molimo za razumijevanje da ECHTE BÄRLINER GmbH® mora štititi svoje intelektualno vlasništvo, uključujući patente, zaštitne znakove i autorska prava, te da ove internetske stranice ne mogu dodijeliti nikakva licencna prava na intelektualno vlasništvo ECHTE BÄRLINER GmbH®.",
    ],
    linksText: [
      ...
      "Na našim stranicama postavili smo poveznice na stranice na internetu čiji sadržaj i ažuriranje nisu u području utjecaja ECHTE BÄRLINER GmbH®.",
      "Za sve te poveznice vrijedi:",
      "ECHTE BÄRLINER GmbH® nema utjecaja na dizajn i sadržaj stranih internetskih stranica. Stoga se ograđuje od svih stranih sadržaja, čak i ako je s ECHTE BÄRLINER GmbH® stranica postavljena poveznica na te vanjske stranice.",
  ...
  sq: {
    ...
    company: [
      "Drejtues: Ugur Maras",
      "Nr. tatimor: 103/125/20058",
      "Nr. i TVSH-së: DE451509739",
    ],
    court: ["Gjykata e Augsburgut", "Selia: Augsburg"],
    owner: ["Pronari i markës: Ugur Maras"],
    web: ["info@echtebaerliner.de", "www.echtebaerliner.de"],
    sections: {
    ...
    copyrightText: [
      "Copyright 2024 ECHTE BÄRLINER GmbH®. Të gjitha të drejtat e rezervuara.",
      ...
      "Disa faqe interneti të ECHTE BÄRLINER GmbH® përmbajnë gjithashtu imazhe që i nënshtrohen të drejtës së autorit të atyre që i kanë vënë në dispozicion.",
    ],
    warrantyText: [
      "ECHTE BÄRLINER GmbH® i ofron informacionet pa asnjë garanci ose sigurim të çfarëdo lloji, qoftë të shprehur apo të nënkuptuar.",
    ...
    licenseText: [
      "ECHTE BÄRLINER GmbH® dëshiron t'ju ofrojë një program interneti inovativ dhe informues. Prandaj shpresojmë që të kënaqeni me dizajnin tonë kreativ po aq sa edhe ne.",
      "Megjithatë, kërkojmë mirëkuptimin tuaj që ECHTE BÄRLINER GmbH® duhet të mbrojë pronën e saj intelektuale, duke përfshirë patentat, markat tregtare dhe të drejtat e autorit, dhe se këto faqe interneti nuk mund të japin asnjë të drejtë licence mbi pronën intelektuale të ECHTE BÄRLINER GmbH®.",
    ],
    linksText: [
      ...
      "Në faqet tona kemi vendosur lidhje me faqe interneti, përmbajtja dhe përditësimi i të cilave nuk janë nën ndikimin e ECHTE BÄRLINER GmbH®.",
      "Për të gjitha këto lidhje vlen:",
      "ECHTE BÄRLINER GmbH® nuk ka asnjë ndikim mbi dizajnin dhe përmbajtjen e faqeve të huaja të internetit. Prandaj ajo distancohet nga çdo përmbajtje e huaj, edhe nëse nga faqet e ECHTE BÄRLINER GmbH® është vendosur një lidhje drejt këtyre faqeve të jashtme.",
  ...
  tr: {
    ...
    address: ["Zollernstraße 11", "86154 Augsburg"],
    company: [
      "Genel Müdür: Ugur Maras",
      "Vergi No. 103/125/20058",
      "KDV No.: DE451509739",
    ],
    court: ["Augsburg Yerel Mahkemesi", "Merkez: Augsburg"],
    owner: ["Marka sahibi: Ugur Maras"],
    web: ["info@echtebaerliner.de", "www.echtebaerliner.de"],
    sections: {
    ...
    copyrightText: [
      "Copyright 2024 ECHTE BÄRLINER GmbH®. Tüm hakları saklıdır.",
      ...
      "Bazı ECHTE BÄRLINER GmbH® internet sayfalarında, bunları sağlayan kişilerin telif hakkına tabi görseller de bulunmaktadır.",
    ],
    warrantyText: [
      "ECHTE BÄRLINER GmbH®, bilgileri açık veya zımni herhangi bir güvence ya da garanti olmaksızın sunmaktadır.",
    ...
    licenseText: [
      "ECHTE BÄRLINER GmbH® size yenilikçi ve bilgilendirici bir internet programı sunmak istemektedir. Bu nedenle yaratıcı tasarımımızdan bizim kadar keyif almanızı umuyoruz.",
      "Bununla birlikte, ECHTE BÄRLINER GmbH®'in patentler, ticari markalar ve telif hakları dahil olmak üzere fikri mülkiyetini korumak zorunda olduğunu ve bu internet sayfalarının ECHTE BÄRLINER GmbH®'in fikri mülkiyeti üzerinde herhangi bir lisans hakkı veremeyeceğini anlayışla karşılamanızı rica ederiz.",
    ],
    linksText: [
      ...
      "Sayfalarımızda, içeriği ve güncelliği ECHTE BÄRLINER GmbH®'in etki alanında olmayan internet sayfalarına bağlantılar bulunmaktadır.",
      "Tüm bu bağlantılar için geçerlidir:",
      "ECHTE BÄRLINER GmbH® yabancı internet sayfalarının tasarımı ve içeriği üzerinde hiçbir etkiye sahip değildir. Bu nedenle, ECHTE BÄRLINER GmbH® sayfalarından bu harici sayfalara bağlantı verilmiş olsa bile tüm yabancı içeriklerden uzak durmaktadır.",
  ...
  return (
    ...
    >
      ...
      <View style={styles.card}>
        ...
        <TextLines lines={t.company} style={styles.textBlock} />
